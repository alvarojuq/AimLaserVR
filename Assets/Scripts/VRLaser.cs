...
public class VRLaser : MonoBehaviour
{
    ...
    public GameObject fetoscopeCamera;
    ...
    void LaserFire()
    {
        ...
        //if (myPoint.BaseCursor)
        {
            ...
            if (theObjectHit != null)
            {
                //this instaniates the ablation prefab, projection it onto the surface of the object that's hit as a temporary GameObject
                //This temp part is important in order to apply it to the parent of the object it's hitting, which allows it to follow colliders placed onto objects
